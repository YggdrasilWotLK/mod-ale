...
namespace LuaTransport
{
     ...
     * @param bool withAll = false : if true, also sets transport movement info on the passenger
     */
     ...
     * @param bool withAll = false : if true, also clears transport movement info from the passenger
     */
